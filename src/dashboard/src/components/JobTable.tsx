          ...
          <table className="w-full text-sm" style={{ tableLayout: 'fixed', userSelect: isResizing ? 'none' : undefined }}>
            <thead>
              <tr className="border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50">
                <ResizableTh width={widths.title} onResizeStart={startResize('title')} className="px-4 py-3 text-left font-medium text-slate-500 dark:text-slate-400">Title</ResizableTh>
